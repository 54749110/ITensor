...
main()
   ...
   printfln("\nGround State Energy = %.10f",energy);
    ...
    std::ofstream outfile3("/mnt/d/OneDrive/programs/vscodepython/marjorana/waveinteraction/outputL");
    for(int j = 4; j < N-1; ++j)
        {
        ...
        outfile3 << j << "\t" << result << std::endl;
        }
    outfile3.close();
     
    //calcualting right majorana <c_j*i*gamma_N>
    std::ofstream outfile4("/mnt/d/OneDrive/programs/vscodepython/marjorana/waveinteraction/outputR");
    for(int j = 4; j < N-1; ++j)
        {
    ...
    std::ofstream outfile5("/mnt/d/OneDrive/programs/vscodepython/marjorana/entanglement/interaction");
