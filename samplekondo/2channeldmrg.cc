...
main()
    ...
    for(auto j : range1(N-3))
        {
        ampo += 0.5,"S+",1,"Cdagup",j+1,"Cdn",j+2;
        ampo += 0.5,"S+",1,"Cdagdn",j+1,"Cup",j+2;
	ampo += 0.5,"S+",N,"Cdagup",j+1,"Cdn",j+2;
	ampo += 0.5,"S+",N,"Cdagdn",j+1,"Cup",j+2;
	ampo +=-0.5,"S+",1,"Cdagup",j+1,"Cdn",j+2;
        ampo +=-0.5,"S+",1,"Cdagdn",j+1,"Cup",j+2;
        ampo +=-0.5,"S+",N,"Cdagup",j+1,"Cdn",j+2;
        ampo +=-0.5,"S+",N,"Cdagdn",j+1,"Cup",j+2;
	ampo += 0.5,"S-",1,"Cdagup",j+1,"Cdn",j+2;
        ...
        ampo += 0.5,"S-",N,"Cdagup",j+1,"Cdn",j+2;
        ampo += 0.5,"S-",N,"Cdagdn",j+1,"Cup",j+2;
	ampo += 1,"Sz",1,"Cdagup",j+1,"Cup",j+2;
        ampo +=-1,"Sz",1,"Cdagdn",j+1,"Cdn",j+2;
        ampo += 1,"Sz",N,"Cdagup",j+1,"Cup",j+2;
        ampo +=-1,"Sz",N,"Cdagdn",j+1,"Cdn",j+2;
       	}
    auto H = toMPO(ampo);
